...
enum StackerCommands {
    ...
    Deploy {
        ...
        /// Skip every shell hook (`pre_build`, `post_deploy`, `on_failure`)
        /// regardless of whether stacker.yml is user-authored or generated.
        /// CI-safe default for automated deploys.
        #[arg(long)]
        no_hooks: bool,
        /// Run hook scripts even when stacker.yml was generated by the

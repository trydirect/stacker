...
pub async fn fetch_by_user(pool: &PgPool, user_id: &str) -> Result<Vec<models::UserAgreement>, String> {
...
pub async fn fetch_by_user_and_agreement(pool: &PgPool, user_id: &str, agreement_id: i32) -> Result<Option<models::UserAgreement>, String> {
    let query_span = tracing::info_span!("Fetch agreements by user id.");
    sqlx::query_as!(
        models::UserAgreement,
        r#"
...
pub async fn fetch_one_by_name(pool: &PgPool, name: &str) -> Result<Option<models::Agreement>, String> {
...
pub async fn insert(pool: &PgPool, mut agreement: models::Agreement) -> Result<models::Agreement, String> {
...
pub async fn insert_by_user(pool: &PgPool, mut item: models::UserAgreement) -> Result<models::UserAgreement, String> {
    let query_span = tracing::info_span!("Saving new agreement into the database");
    sqlx::query!(
        r#"
...
pub async fn update(pool: &PgPool, mut agreement: models::Agreement) -> Result<models::Agreement, String> {
